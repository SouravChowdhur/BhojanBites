...
const Navbar = () => {
  ...
  const getUser = async () => {
    const res = await axios.get("https://bhojanbitesbackend.onrender.com/api/get-user", {
  ...
  return (
    <nav className="flex flex-col lg:flex-row justify-between py-3 mx-6 mb-10">
      ...
      <GiHamburgerMenu
        className={`absolute top-5 right-5 lg:right-8 lg:top-6 text-2xl text-pink-500 cursor-pointer ${
          toggleNav && "hidden"
